...
class MilitarRepositoryMongo extends MilitarRepository{
    ...
    async save(militar){
        ...
        const mongoMilitar = new MilitarSchema({nombre,activo,nacionalidad,cc,autoridad,genero,edad})
        await mongoMilitar.save()
        return new Militar(mongoMilitar._id,mongoMilitar.nombre,mongoMilitar.activo ,mongoMilitar.nacionalidad,mongoMilitar.cc,mongoMilitar.autoridad,mongoMilitar.genero,mongoMilitar.edad)
    }
